...
// runtime tagged structure and reshape to wire form (positional list when
// all-required, named map when any field is optional). Inbound: reconstruct
// the tagged structure given a `::Name` annotation and wire payload.
//
...
// Slice 12 inbound: walk a packed Structure (`positional` + `named`)
// alongside the parallel bv-a tag structure and reconstruct any
