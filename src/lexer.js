const KEYWORDS = new Set(['returns', 'type', 'end', 'of', 'null', 'over', 'reduce', 'if', 'else', 'true', 'false', 'while', 'repeat', 'until', 'uses', 'spawn', 'as', 'self', 'set', 'update', 'emit', 'on', 'constructs', 'ingest']);
