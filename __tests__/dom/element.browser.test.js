...
// ═══════════════════════════════════════════════════════════════════════════════
// HTML element construction — service side
//
// connectActor establishes a com channel to an existing address (like "HTML @div")
// so we can send messages and assert replies using the same step-list pattern
// as expectActorBehavior.
// ═══════════════════════════════════════════════════════════════════════════════

describe('HTML element construction — service side', () => {
...
// ═══════════════════════════════════════════════════════════════════════════════
// HTML element construction — actor side
//
...
describe('HTML element construction — actor side', () => {
  const html = `<html><head>
    <script type="module" src="/src/codegen/browser/brevity.js"></script>
