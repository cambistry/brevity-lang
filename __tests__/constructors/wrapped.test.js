...
describe('wrapped child — runtime with *', () => {
  const script = `
    ...
    @testPos
      ...
      i = Inner()
      w = WrapperPos(i)
      :result Integer = w.quadruple(n: 5)
      -> :result
