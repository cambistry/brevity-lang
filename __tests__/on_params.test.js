...
describe('on params — same-line no-paren', () => {
  it('single named param :n : Integer', async () => {
    ...
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { go: { n: 42 } }, to: 'caller' });
  });
  ...
  it('two named params :n : Integer, :m : Integer', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { go: { sum: 7 } }, to: 'caller' });
  });
  ...
  it('positional param n : Integer', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { go: [99] }, to: 'caller' });
  });
  ...
  it('two positional params a : Integer, b : Integer', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { add: { sum: 11 } }, to: 'caller' });
  });
  ...
  it('body follows on next line without blank line', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { ping: { x: 7 } }, to: 'caller' });
  });
...
describe('on params — open style', () => {
  ...
  it('single param :n : Integer blank-line terminated', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { go: { n: 10 } }, to: 'caller' });
  });
  ...
  it('two params blank-line terminated', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { add: { sum: 30 } }, to: 'caller' });
  });
  ...
  it('single param terminated by -- comment', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { go: { n: 55 } }, to: 'caller' });
  });
  ...
  it('single param terminated by bare //', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { go: { n: 33 } }, to: 'caller' });
  });
  ...
  it('multiple handlers: open style does not bleed into next handler', async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 0));
    expect(binding.post).toHaveBeenCalledWith({ id: '1', re: { foo: { x: 1 } }, to: 'caller' });
    expect(binding.post).toHaveBeenCalledWith({ id: '2', re: { bar: { y: 2 } }, to: 'caller' });
  });
});
